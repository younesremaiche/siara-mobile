      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.actionsGrid}>
            {QUICK_ACTIONS.map((a, i) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('AdminMain', { screen: a.screen })}
                activeOpacity={0.7}
              >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('AdminMain', { screen: 'AdminIncidents' })}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('AdminMain', { screen: 'AdminAI' })}>
